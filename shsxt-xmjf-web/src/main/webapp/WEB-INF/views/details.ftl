...
<div class="invest_container">
    <div class="invest_item">
        ...
        <div class="invest_detail">
            <div>
                <p class="rate"><strong class="rate_int">${item.itemRate}</strong>
                	<span class="percent">%
                        <#if item.itemAddRate?? &&  item.itemAddRate  lt 0>
                            +${item.itemAddRate}%
                        <#else>
            ...
            <div class="radialIndicator" >
                <p id='rate' data-val="${item.itemScale}"></p>
                <p class="details_text">项目进度</p>
            </div>
        </div>
                ...
                <tr>
                    ...
                    <#if item.itemSingleMaxInvestment?? && item.itemSingleMaxInvestment gt 0>
                        <em id="minInvestMoney" data-value='${item.itemSingleMinInvestment}'>
                              ...
                              <#else >
                                  <em id="minInvestMoney"  data-value='0'>
                                 无限制
                              </em>
                    </#if>
                    ...
                    <#if item.itemSingleMaxInvestment?? && item.itemSingleMaxInvestment gt 0>
                          <em id="maxInvestMoney" data-value='${item.itemSingleMaxInvestment?c}'>
                            ...
                            <#else>
                                <em id="maxInvestMoney"  data-value='0'>
                                无限制
                            </em>
                        </#if>
        ...
        <div class="invest_panel">
            <p class="text">剩余金额：${item.syAmount?c}元</p>
             <#if userInfo??>
            <p class="text left_account">
                <#if busAccount.usable?? && busAccount.usable gt 0>
                    <span id="ye" data-value='${busAccount.usable?c}'>账户余额：${busAccount.usable?c}</span>
                <#else>
                    <span id="ye"   data-value='0'>账户余额：0</span>
                </#if>
          ...
          <p class="input_wrap clear" style="margin-top:-12px;">
             ...
             <#-- &lt;#&ndash; &lt;#&ndash;<span class="caculator fl"></span>&ndash;&gt;&ndash;&gt;-->
            </p>
        ...
        <div id="contents">
          ...
          <div class="table_box">
              <table class="table_base">
                  ...
                  <tbody>
                  <tr><td>姓&nbsp;&nbsp;&nbsp;&nbsp;名</td><td>${userSecurity.realname}</td>
                      <td>车型</td><td>haval</td></tr>
                  <tr>
                      <td>身份证号</td><td>
                         ${userSecurity.identifyCard}
         </td><td>上牌时间</td><td>
                            ${itemLoan.licensingTime?string("yyyy年MM月dd日")}
                  </td></tr>
                  <tr><td></td><td></td><td>公里数</td><td>${itemLoan.kilometers}万公里</td></tr>
                  <tr><td>首付金额</td><td>${itemLoan.firstPayAmount}元</td><td>评估价</td><td>${itemLoan.assessPrice}元</td>
                  </tr>
                  </tbody>
                </table>
            </div>
